...
export const ProductsList: React.FC<ProductsListProps> = ({ products, setProducts, setDeletedProducts }) => {
	const	router = useRouter();

    const	handleDelete = async(id: number) => {
		const	updatedProducts = await useFetch({ url: DELETE_PRODUCT_BY_ID + `?product_id=${id}`, method: 'DELETE' });
